...
| core_processing | dev-core_processing | worktrees/core_processing/ | 待合并 | M2 完成（§4.2 接口 + 5 内置算法 + Registry + ProcessingPipeline + 金标准测试全绿），等主控软件审查 + 人工审查后合回 main | MODULE_03, MODULE_04, MODULE_09, MODULE_10 | 无（已同步含 M1 的 main） |
